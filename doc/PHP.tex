...
Die Klasse class.resolver hat die wichtigste Funktion in der Logik. Sie überprüft, welche Werte sich im POST und GET befinden, und führt somit die entsprechende Funktion in den entsprechenden Klassen aus.
\subsubsection{View}
...
\begin{figure}[htbp]
		\centering
	\includegraphics[width= 15cm]{C:/inetpub/wwwroot/auswertung/doc/img/entwurf-suchen.jpg}
		\label{fig:Entwurf Suchen}
\end{figure}
\begin{figure}[htbp]
		\centering
	\includegraphics[width= 15cm]{C:/inetpub/wwwroot/auswertung/doc/img/entwurf-package.jpg}
		\label{fig:Entwurf Package}
\end{figure}
\begin{figure}[htbp]
		\centering
	\includegraphics[width= 15cm]{C:/inetpub/wwwroot/auswertung/doc/img/entwurf-update.jpg}
