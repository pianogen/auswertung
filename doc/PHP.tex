...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Name} & \textbf{Was wird getestet} & \textbf{Resultat} \\ \hline
constructTest() & Es wird getestet, ob die Datenbankverbindung aufgebaut werden kann. Falls die Verbindung aufgebaut werden kann wird ein True zurückgegeben. & Erfolgreich \\ \hline
findIdTest() & Es wird getestet, ob mit Hilfe eines GET-Werts, ein Datensatz gefunden werden kann. Falls ein Datensatz gefunden wird, wird ein nicht leeres Objekt zurückgegeben. & Erfolgreich \\ \hline
getPackackagesTest() & Es wird getestet, ob mit Hilfe eines GET-Wertes,  
\end{tabular}
\section{Fazit}
\subsection{Review}
